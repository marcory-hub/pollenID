...
3. Run `@update-pollen` / `add_taxon.py --slug callicarpa_bodinieri --render-pages` then validate.
4. Confirm species page has gallery + Kenmerken + Determinatiesleutels.
