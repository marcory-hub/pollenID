...
Type-omschrijvingen: Kerkvliet 2014, "Pollentypen in de Asteraceae". Letters in de stekelsectie van dezelfde tabel. Beug-verwijzingen: sleutel 17.1 en 29 (fenestratae). Termen (echinaat, verrucaat, fenestraat): [Punt et al. 2007, glossary](http://www3.bio.uu.nl/palaeo/glossary/glos-int.htm).

## Type-overzicht

| Type | Kenmerk | Beug (indicatief) |
| :--- | :--- | :--- |
| **A**(chillea) | dikke exine met dwarsstreping en korte stekels/wratten | 17.1.6 *Matricaria*-type |
| **C**(entaurea) | exine verrucaat/reticulaat, geen stekels | Beug 14.14 (*C. cyanus*); niet echinaat |
| **H**(elianthus) | dunnere exine zonder dwarsstreping, wel overlangse streping en fijne stekels | 17.1.12 *Senecio*-type |
| **J**(acea) | exine met ringvormige streping met zeer korte stekels | 17.1.10 *Centaurea jacea*-type |
| **S**(errulata) | disteltype: dikke exine met zuilenbouw en brede stekels; pollen meestal ca. 40 µm, met olie | 17.1.7–17.1.11 (*Cirsium* / *Carduus* / *Saussurea*) |
| **T**(araxacum) | exine met vensters (fenestraat), stekels op de lijsten | 29 Fenestratae |

Niet in dit letter-schema (echinaat A–T): *Galinsoga* (echinaat zonder letter), *Jasione* (Campanulaceae). *Centaurea cyanus* / *C. montana* horen bij **C**-type (geen stekels).
...
Exine verrucaat/reticulaat, **geen** stekels.
...
Niet C-type: *Centaurea jacea* (echinaat **J**). *Echinops* staat in Kerkvliet als "echinaat C" in de stekelsectie: dat is een andere lettertag, niet dit Centaurea-type.
...
Nog geen foto's (bron bevestigt genus/soort): *Erigeron*, *Petasites*, *Tagetes*, *Tussilago*, *Solidago canadensis* (YAML zonder by-taxon PNG).
...
Nog geen foto's: *Cnicus benedictus*.
...
Nog geen foto's: *Serratula tinctoria*, *Onopordum* / *Onopordon*, *Silybum* (*Sylibum* in bron).
...
Nog geen foto's: *Picris*, *Leontodon*, *Lapsana* (*Lampsana* in bron), verdere *Crepis* / *Hieracium* / *Sonchus*-soorten in `_todo/` zonder PNG.

---

## Backlog (genus bevestigd, nog geen bruikbare foto's)

Lege `_todo/`-mappen; geen nieuwe soortpagina's tot er PNG's liggen. Daarna: `scripts/add_taxon.py --slug <key> --kerkvliet --render-pages`.

| Type | Genus / taxa (bron) |
| :--- | :--- |
| H | *Tagetes*, *Erigeron*, *Petasites*, *Inula helenium* |
| T | *Picris echioides*, *Leontodon*, *Lapsana*, overige *Sonchus* / *Crepis* / *Hieracium* |
| S | *Serratula*, *Onopordum*, *Silybum* |
| — | [to be verified] queue-entry `santolina_jasione` ("Santolina Jasione montana"; vermoedelijk samengevoegd/verkeerd gelabeld) |

## Bronnen

| Bron | Rol |
| :--- | :--- |
| Kerkvliet, *Determinatietabel voor pollen in Nederlandse honing* (2014) | letters A/C/H/J/S/T; type-omschrijvingen |
