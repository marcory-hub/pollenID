...
- Van der Ham, Kaas, Kerkvliet & Neve - *Pollenanalyse: Stuifmeelonderzoek van honing voor imkers, scholen en laboratoria* (Ambrosiushoeve, 1999).
- Von der Ohe et al. (IHC) - *Harmonized methods of melissopalynology* (Apidologie, 2004).
- Persano Oddo & Bogdanov - *Determination of honey botanical origin: problems and issues* (Apidologie, 2004).
- Persano Oddo & Piro - *Main European unifloral honeys: descriptive sheets* (Apidologie, 2004).
- Kerkvliet - *Praktische stuifmeelanalyse van honing en pollenklompjes* (1992, praktijkartikel).
- Canlı, A. & Bayram, N.E. (eds.) - *Melissopalynology: Bee Flora, Pollen and Honey* (Elsevier, 2025).

## Praktische preparatie en microscopie
- Klaus Henkel - *Pollen sammeln und präparieren* (werknotities/protocolvorm, OCR-bron).
