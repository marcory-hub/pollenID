...
- `Ornamentatie eureticulaat (netwerk ìs tectum) -> netwerk duidelijk -> mazen groter dan 1 um -> PK kleiner dan 40 um -> wand meestal dikker dan 2 um - pori hoger dan breed`
