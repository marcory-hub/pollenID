...
| pollen-note | Kerkvliet: 17 µm; fijn reticulaat |
...
deutzia_typ:
  ...
  links:
    pollenX: https://pollenx.eu/species.php?species=Deutzia_sp
    tstebler: https://pollen.tstebler.ch/MediaWiki/index.php?title=Deutzia_sp
    paldat: https://www.paldat.org/pub/Deutzia_sp
    waarneming: https://waarneming.nl/search/?q=deutzia+sp
  images: []
