...
phacelia_tanacetifolia:
  ...
  - path: assets/images/by-taxon/phacelia_tanacetifolia/phacelia_tanacetifolia_1.png
    kind: pollenwiki
    source: pollenwiki
  - path: assets/images/by-taxon/phacelia_tanacetifolia/phacelia_tanacetifolia_2.png
    kind: pollenwiki
    source: pollenwiki
  - path: assets/images/by-taxon/phacelia_tanacetifolia/phacelia_tanacetifolia_3.png
    kind: pollenwiki
    source: pollenwiki
...
- Stap 17:
  - <span class="pid-key-choice pid-key-choice--on">Pollenkorrel alleen met colpi (hier niet *Ephedra*; vergelijk p. 64).</span>
  - <span class="pid-key-choice pid-key-choice--off">pollenkorrel alleen met pori.</span>
- Eindpunt: [Stephanocolpatae](beug17-stephanocolpatae.md)

</details>

<details><summary>24. Stephanocolpatae (Beug)</summary>

- Stap 1:
  - <span class="pid-key-choice pid-key-choice--off">PK echinaat.</span>
  - <span class="pid-key-choice pid-key-choice--on">PK reticulaat, endo-reticulaat, microreticulaat, retipilaat, rugulaat, psilaat of scabraat.</span>
- Stap 3:
  - <span class="pid-key-choice pid-key-choice--on">PK met 6 Colpi, waarvan elke tweede een contrastrijk korrelig opgeloste intercolpiumranden grenst (Tafel 84: 12-18).</span>
  - <span class="pid-key-choice pid-key-choice--off">intercolpiumranden gleichartig.</span>
- Eindpunt: 24.3 Phacelia tanacetifolia (Blz. 382)
