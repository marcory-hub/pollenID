...
senecio_typ:
  ...
  links:
    pollenX: https://pollenx.eu/species.php?species=Senecio_sp
    tstebler: https://pollen.tstebler.ch/MediaWiki/index.php?title=Senecio_sp
    paldat: https://www.paldat.org/pub/Senecio_sp
    waarneming: https://waarneming.nl/search/?q=senecio+sp
  images: []
