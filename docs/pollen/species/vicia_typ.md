...
2.4. **Lang** Ongeveer 1½ keer zo lang als breed (Fig. 3d) (Vicia, tuinboon, Pl. 73).

5. Vicia (Bean) type. V. faba (Field, or Broad Bean), Vicia spp. (Vetches) and Lathyrus (Peas and Vetchlings) all similar, often smooth surface.
...
- `PK  rond tot prolaat (P groter of gelijk ) -> wand dunner dan 2 um - zuiltjes in infratectum klein of onduidelijk -> netwerk onduidelijk`

## Determinatiesleutels

Sleutelpaden via exemplaar *Vicia faba* (type-sleutel `vicia_typ` heeft nog geen `pollen_key` in de JSON).
...
- Stap 65:
  - <span class="pid-key-choice pid-key-choice--off">wand dikker dan 2 µm, zuiltjes in infratectum zeer duidelijk, vertakt</span>
  - <span class="pid-key-choice pid-key-choice--on">wand dunner dan 2 µm, zuiltjes in infratectum klein of onduidelijk</span>
- Stap 66:
  - <span class="pid-key-choice pid-key-choice--off">netwerk onduidelijk</span>
  - <span class="pid-key-choice pid-key-choice--on">netwerk duidelijk</span>
- Stap 67:
  - <span class="pid-key-choice pid-key-choice--on">pollenkorrel kleiner dan 40 µm</span>
  - <span class="pid-key-choice pid-key-choice--off">pollenkorrel groter dan 40 µm</span>
- Eindpunt: Fabaceae (*Trifolium, Vicia*)
