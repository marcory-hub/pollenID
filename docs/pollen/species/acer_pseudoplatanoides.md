...
acer_pseudoplatanoides:
  ...
  - path: assets/images/by-taxon/acer_pseudoplatanoides/acer_pseudoplatanoides_1.png
    kind: by_taxon
    source: by_taxon
  - path: assets/images/by-taxon/acer_pseudoplatanoides/acer_pseudoplatanoides_2.png
    kind: by_taxon
    source: by_taxon
  - path: assets/images/by-taxon/acer_pseudoplatanoides/acer_pseudoplatanoides_3.png
    kind: by_taxon
    source: by_taxon
...
- Stap 33:
  - <span class="pid-key-choice pid-key-choice--on">ornamentatie-elementen (muri) vooral meridionaal (± loodrecht op equatoriale vlak)</span>
  - <span class="pid-key-choice pid-key-choice--off">ornamentatie-elementen (muri) meestal dwars (± parallel aan equatoriale vlak)</span>
