...
quercus_robor:
  ...
  links:
    ...
    waarneming:
  images:
  - path: assets/images/by-taxon/quercus_robor/quercus_robor_1.png
    kind: by_taxon
    source: by_taxon
  - path: assets/images/by-taxon/quercus_robor/quercus_robor_2.png
    kind: by_taxon
    source: by_taxon
  - path: assets/images/by-taxon/quercus_robor/quercus_robor_3.png
    kind: by_taxon
    source: by_taxon
  - path: assets/images/by-taxon/quercus_robor/quercus_robor_4.png
    kind: by_taxon
    source: by_taxon
```
