# *Hippophaë rhamn* (duindoorn)

{{ gallery("hippopha_rhamn") }}

## Kenmerken

| Veld | Waarde |
|---|---|
| Latijn | Hippophaë rhamn |
...
hippopha_rhamn:
  ...
  links:
    pollenX: https://pollenx.eu/species.php?species=Hippophaë_rhamn
    tstebler: https://pollen.tstebler.ch/MediaWiki/index.php?title=Hippophaë_rhamn
    paldat: https://www.paldat.org/pub/Hippophaë_rhamn
    waarneming: https://waarneming.nl/search/?q=hippopha%C3%AB+rhamn
  images: []
