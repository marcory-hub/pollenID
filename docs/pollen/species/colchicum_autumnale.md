...
colchicum_autumnale:
  ...
  images:
  - path: assets/images/by-taxon/colchicum_autumnale/colchicum_autumnale_1.png
    kind: by_taxon
    source: by_taxon
  - path: assets/images/by-taxon/colchicum_autumnale/colchicum_autumnale_2.png
    kind: by_taxon
    source: by_taxon
  - path: assets/images/by-taxon/colchicum_autumnale/colchicum_autumnale_3.png
    kind: by_taxon
    source: by_taxon
  - path: assets/images/by-taxon/colchicum_autumnale/colchicum_autumnale_4.png
    kind: by_taxon
    source: by_taxon
```
