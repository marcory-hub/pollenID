...
- Voor *Helianthus*-honing wordt een **sterk variabel pollenpercentage** beschreven (van lage tot hoge fracties).
- In deze context is variatie tussen rassen/cultivars een plausibele verklaring; interpreteer zonnebloem daarom met lokale teeltcontext en totaalprofiel [to be verified].
