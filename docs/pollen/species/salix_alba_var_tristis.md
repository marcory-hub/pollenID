...
salix_alba_var_tristis:
  ...
  - path: assets/images/by-taxon/salix_alba_var_tristis/salix_alba_var_tristis_1.png
    kind: by_taxon
    source: by_taxon
  - path: assets/images/by-taxon/salix_alba_var_tristis/salix_alba_var_tristis_2.png
    kind: by_taxon
    source: by_taxon
  - path: assets/images/by-taxon/salix_alba_var_tristis/salix_alba_var_tristis_3.png
    kind: by_taxon
    source: by_taxon
...
- Stap 24:
  - <span class="pid-key-choice pid-key-choice--on">mazen duidelijk kleiner naar de colpi toe, colpusranden meestal naar binnen gevouwen</span>
  - <span class="pid-key-choice pid-key-choice--off">mazen niet duidelijk kleiner naar de colpi toe, colpusranden reticulaat</span>
- Eindpunt: Salicaceae (*Salix*)
