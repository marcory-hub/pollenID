...
- Binnen de referentieset vallen *Brassica napus*, *B. oleracea* en *B. rapa* in hetzelfde kernpatroon: tricolpaat, (micro)reticulaat en monaden.
- Grootteband in de bronnotities ligt ruwweg in de kleine tot medium klasse (ongeveer 22-30 um), met overlap tussen soorten.
- Praktisch gevolg: op LM-niveau is soortniveau vaak niet robuust; rapporteer bij twijfel als *Brassica*-type of Brassicaceae-type.

### Aanvulling uit Oddo et al. (2004)

- In de Europese uniflorale context wordt *Brassica*-pollen meestal als **normaal vertegenwoordigd** beschreven.
- Dit past bij praktijkgebruik waarin *Brassica*-honing vaak een relatief zuiver pollenspectrum kan geven in voorjaarsdrachten [to be verified].

## Drachtplantgegevens (Imkerpedia)

- Latijnse naam: *Brassica napus*
- Nederlandse naam (Imkerpedia): Koolzaad
- Voorkomen: 2-jarig
- Stuifmeelkleur: Geel
- Nectarwaarde: N 5
- Pollenwaarde: P 5
