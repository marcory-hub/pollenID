...
- `Een losse PK - monade -> PK zonder luchtzakken -> PK zonder vensters -> PK zonder aperturen (inaperturaat) -> PK ongeveer rond -> Ornamentatie perforaat tot fijn reticulaat - PK niet gespleten`
